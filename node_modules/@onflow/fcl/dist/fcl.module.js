...
const execServiceHandlerFactory = ({
  onExecResult,
  execStrategyOpts,
  execStrategyArgs,
  abortSignal
...
function createDiscoveryRpcClient({
  onExecResult,
  body,
  opts,
  args,
...
async function execStrategyHook(...args) {
  const [opts] = args;
  const {
    body,
