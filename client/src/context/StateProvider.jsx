...
export const StateProvider = ({ children }) => {
  ...
  // BUG FIX: Initialize userData to null (not {}) when no token exists.
  // The original code used {} as the fallback, which made every
  // "userData != null" check always true, hiding login state bugs throughout
  // the app (e.g. the mobile drawer showed nav items even for guests).
  ...
  const logout = () => {
    try {
      ...
      setUserData(null);  // BUG FIX: was {} — now matches null-based auth check
